...
tags:
  ...
  - Python
draft: true
images: ["images/powerbi_with_python.png"]
---

Microsoft have recently enabled **Python** script as a data source. This is still an experimental phase, yet a nice feature for those who uses Python on a day to day basis. *Microsoft Power BI* Desktop version nicely integrates with **Python**. Python is an open source general purpose language and has become one of top prigramming language for data science. *Power BI* is Microsoft's flagship BI tool for creating dashboards and interactive reports. 
...
![Python script interface in Power BI](/images/r_script_fields_pane.png)
...
![Edit Python script](/images/edit_r_script.png)
...
![Python script Window](/images/python_script_window.png)

Enter the Python code that will be used to do the transformation. The screen would look like the following:

![Python script Window](/images/python_script_trans_code.png)
