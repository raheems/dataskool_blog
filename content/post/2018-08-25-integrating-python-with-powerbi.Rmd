...
In a [previous article](https://blog.dataskool.org/post/integrating-r-with-powerbi-desktop/), I've demonstrated how to use R with Power BI. In this article, I demonstrate how Python can be integrated with Power BI to perform these applications.
